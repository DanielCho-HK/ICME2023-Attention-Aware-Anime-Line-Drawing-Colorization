...
from VGG import VGG
from model_SGA import Generator_SGA, Discriminator
...
log_dir = './logs_SGA/'
checkpoint_dir = './train_SGA/checkpoint/'
sample_dir = './train_SGA/sample/'
...
if __name__ == "__main__":
    ...
    generator = Generator_SGA(sketch_channels=1, reference_channels=3)
    generator.to(device)
